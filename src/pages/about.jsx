            ...
            <div className="flex flex-col lg:flex-row justify-between w-full h-full py-24 gap-24">
                <div>
                    ...
                    <p className="text-xl mt-1">
                        Hello, Im at00m. I am 15 years old.
                        I am a 1st year high school student, I have been dealing with software for about 3 years.
                ...
                <div className="relative flex-shrink-0">
                    <img src="https://r.resimlink.com/WFV0CXL.jpg?v=520babfb2f7f6e42a0117ae71972b9b1" style={{ zIndex: 1 }} className="relative shadow-xl z-1 w-full lg:w-64 h-full lg:h-64 rounded-full lg:rounded-lg" />
