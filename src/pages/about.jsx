        ...
        <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row justify-between w-full h-full py-24 gap-24">
                ...
                <div className="relative flex-shrink-0">
                    <img src="https://r.resimlink.com/hxoOpje.png" style={{ zIndex: 1 }} className="relative shadow-xl z-1 w-full lg:w-64 h-full lg:h-64 rounded-full lg:rounded-lg" />
                    <div className="-right-3 top-3 absolute w-full h-full top-0 right-0 border-4 border-primary bg-gradient-to-t from-primary" />
                </div>
            </div>
        </div>
